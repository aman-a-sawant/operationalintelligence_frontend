...
export function TimelineTab() {
  const events = [
    ...
    { time: '10:25 AM', title: 'AI Investigator Agent Triggered', desc: 'AppDynamics Davis AI initiated multi-service trace correlation', tag: 'AI Engine', color: 'border-purple-400 text-purple-300' },
