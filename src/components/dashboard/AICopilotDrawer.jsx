  ...
  const [messages, setMessages] = useState([
    {
      id: '1',
      sender: 'ai',
      text: "Hello Admin! I'm OPINTEL AI Copilot. I've detected a Critical Incident on the **Checkout Service**. Would you like me to generate a SQL index migration or analyze recent trace latency?",
      timestamp: '17:22'
    }
  ]);
  ...
  const handleSend = (textToSend) => {
    ...
    setTimeout(() => {
      ...
      if (query.toLowerCase().includes("sql") || query.toLowerCase().includes("migration") || query.toLowerCase().includes("fix")) {
        ...
        responseText = `OPINTEL AI evaluated telemetry for "${query}". All microservice traces point to database query latency on cluster \`pg-primary-us-east-1\`. Confidence score: 92%.`;
      }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-bold text-white text-base">OPINTEL AI Copilot</h3>
          ...
          {isTyping && (
            <div className="flex gap-3 items-center">
              ...
              <div className="p-3 rounded-2xl bg-slate-900 border border-slate-800 text-xs text-purple-400 flex items-center gap-2">
                ...
                <span>OPINTEL AI is computing root cause...</span>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900/80">
          ...
          >
            <input
              ...
              placeholder="Ask OPINTEL AI about latency, logs, or remediation..."
